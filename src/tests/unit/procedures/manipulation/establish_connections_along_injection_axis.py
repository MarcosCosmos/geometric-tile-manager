...
class Cases(unittest.TestCase):
    def test_single_row_of_flush_windows(self):
        ...
        establish_connections_along_injection_axis(second_window, HORIZONTAL, ([first_window.corners[NORTH_EAST]], [first_window.corners[SOUTH_EAST]]), ([third_window.corners[NORTH_WEST]], [third_window.corners[SOUTH_WEST]]))
        ...
        for i in range(len(all_windows)-1):
            ...
            for each_dir in VERTICAL.directions:
    ...
    def test_single_column_of_flush_windows(self):
        ...
        establish_connections_along_injection_axis(second_window, VERTICAL, ([first_window.corners[SOUTH_WEST]], [first_window.corners[SOUTH_EAST]]), ([third_window.corners[NORTH_WEST]], [third_window.corners[NORTH_EAST]]))
        ...
        for i in range(len(all_windows)-1):
            each_window = all_windows[i]
            next_window = all_windows[i+1]
            for each_dir in HORIZONTAL.directions:
